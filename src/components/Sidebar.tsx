...
export const Sidebar = () => {
    return (
        <div className="SideBar">
            ...
            <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-60 h-screen transition-transform -translate-x-full xl:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-[#1C1C26] dark:bg-gray-800">
                    <a href="https://electrifyitnow.com/" className="flex items-center mb-5">
                        <img src={Logo} className="w-20 text-white" alt="ElectrifyIt Logo" />
                        <span className="text-white text-xl">Electrify</span>
                        <span className="text-blue-700 text-xl">It</span>
                    </a>
                    <ul className="space-y-2 mt-10 font-medium">
                        <li>
                            <a href="#" className="flex items-center p-2 text-white text-lg rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
